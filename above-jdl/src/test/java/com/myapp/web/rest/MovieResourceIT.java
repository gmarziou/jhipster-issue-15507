...
import com.myapp.repository.MovieRepository;
...
class MovieResourceIT {
    ...
    public static Movie createEntity(EntityManager em) {
        Movie movie = new Movie().name(DEFAULT_NAME);
        return movie;
    }
    ...
    public static Movie createUpdatedEntity(EntityManager em) {
        Movie movie = new Movie().name(UPDATED_NAME);
        return movie;
    }
    ...
    void putNewMovie() throws Exception {
        ...
        updatedMovie.name(UPDATED_NAME);
    ...
    void partialUpdateMovieWithPatch() throws Exception {
        ...
        partialUpdatedMovie.name(UPDATED_NAME);
